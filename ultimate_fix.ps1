...
# CORRUPTION FIX MAP (ASCII safe replacements)
$fixMap = @{
    "Ã¢â‚¬â€œ" = "-"
    "Ã¢â‚¬â”" = "--"
    "Ã¢â‚¬Ëœ" = "'"
...
# ======================================================
# FUNCTION: SIMPLE INDIA NUMBER FORMATTER (ASCII only)
# ======================================================
...
Write-Host "========================================="
Write-Host "ASCII-SAFE ULTIMATE FIX COMPLETE"
